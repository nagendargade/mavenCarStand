...
import carstand.in.zorocars.appliUser.ApplicationUserService;
import carstand.in.zorocars.appliUser.UserType;
import carstand.in.zorocars.email.EmailSender;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
        ...
        String token = applicationUserService.signUpUser(
                new ApplicationUser(
                        ...
                        request.getAddress(),
                        request.getPassword(),
                        request.getMoblieNumber(),
                        UserType.USER)
        );

      String link = "http://localhost:8080/api/v*/registration**" + token;
        emailSender.send(
                request.getEmail(),
    ...
    public String confirmToken(String token) {
        ...
        applicationUserService.enableAppliUser(
